    ...
    <div class="barreEmailInscription row">
      <div class="col-md-9">
        ...
        <form class="formEmail" action="<?php echo $this->url('admin_assos_register'); ?>" method="GET">
          ...
          <div class="col-md-3">
            <button type="submit" class="btn btn-circle btn-lg inscripAssos"><i class="fa fa-check fa-2x" aria-hidden="true"></i></button>
          </div>
        </form>
    </div>
  <?php } ?>
    ...
    <div class="container-fluid explications">
      <div class="row">
        <div class="col-md-6 col-md-push-3">
          <h2 id="concept" class="white">A-Swap, c'est quoi ?</h2>
          <p>
